...
"perfil.bio":"Soy José Manuel Velazco Ochoa, Ingeniero Topógrafo Geomático titulado por la Universidad de Colima, recién egresado y disponible para proyectos nacionales e internacionales. Me motiva ver cómo la información procesada se proyecta al terreno real: del dato preciso a la decisión en campo. Integro levantamiento con estación total, GNSS y dron RTK con procesamiento en SIG y automatización en Python para entregar información confiable en cada etapa del proyecto.",
...
"exp.autofit":"ENCUADRE AUTOMÁTICO","exp.geoms":"GEOMETRÍAS","exp.zoomhint":"ZOOM P/ MARCADORES",
"exp.all":"TODOS","exp.pais":"MÉXICO","exp.vermap":"⌖ VER EN MAPA","exp.nomatch":"Sin coincidencias.",
"exp.reg":"REGISTRO","exp.regs":"REGISTROS","exp.de":"DE",
"exp.statExp":"EXPERIENCIAS","exp.statEst":"ESTADOS","exp.statCampo":"DE CAMPO",
...
"v.ready":"Listo para verificar","v.official":"Página oficial ↗","v.connecting":"Conectando con titulacion.ucol.mx…","v.validating":"Validando código de verificación…","v.showing":"Mostrando resultado…","v.done":"Verificación oficial · Universidad de Colima",
...
"contact.head":"ESCRÍBEME","contact.headNote":"// SE ABRE EN TU CLIENTE DE CORREO",
...
"contact.submit":"ABRIR EN TU CORREO ✉","contact.hint":"Sin servidores intermedios: el mensaje se redacta en tu propio correo.",
"contact.mail":"CORREO","contact.tel":"TELÉFONO","contact.linkedin":"LINKEDIN","contact.copy":"COPIAR","contact.copied":"COPIADO ✓","contact.open":"ABRIR ↗",
...
"perfil.bio":"I am José Manuel Velazco Ochoa, a licensed Geomatics Topographic Engineer from the University of Colima, recent graduate available for national and international projects. I am driven by seeing processed information projected onto real terrain: from precise data to field decisions. I integrate total-station, GNSS and RTK-drone surveys with GIS processing and Python automation to deliver reliable information at every project stage.",
...
"exp.autofit":"AUTO FRAMING","exp.geoms":"GEOMETRIES","exp.zoomhint":"ZOOM FOR MARKERS",
"exp.all":"ALL","exp.pais":"MEXICO","exp.vermap":"⌖ VIEW ON MAP","exp.nomatch":"No matches.",
"exp.reg":"RECORD","exp.regs":"RECORDS","exp.de":"OF",
"exp.statExp":"EXPERIENCES","exp.statEst":"STATES","exp.statCampo":"IN THE FIELD",
...
"v.ready":"Ready to verify","v.official":"Official page ↗","v.connecting":"Connecting to titulacion.ucol.mx…","v.validating":"Validating verification code…","v.showing":"Showing result…","v.done":"Official verification · University of Colima",
...
"contact.head":"WRITE ME","contact.headNote":"// OPENS IN YOUR MAIL CLIENT",
...
"contact.submit":"OPEN IN YOUR MAIL ✉","contact.hint":"No middle servers: the message is drafted in your own mail client.",
"contact.mail":"EMAIL","contact.tel":"PHONE","contact.linkedin":"LINKEDIN","contact.copy":"COPY","contact.copied":"COPIED ✓","contact.open":"OPEN ↗",
...
"perfil.bio":"Sou José Manuel Velazco Ochoa, Engenheiro Topógrafo Geomático formado pela Universidade de Colima, recém-graduado e disponível para projetos nacionais e internacionais. Motiva-me ver a informação processada projetada no terreno real: do dado preciso à decisão em campo. Integro levantamentos com estação total, GNSS e drone RTK com processamento em SIG e automação em Python para entregar informação confiável em cada etapa do projeto.",
...
"exp.autofit":"ENQUADRAMENTO AUTOMÁTICO","exp.geoms":"GEOMETRIAS","exp.zoomhint":"ZOOM P/ MARCADORES",
"exp.all":"TODOS","exp.pais":"MÉXICO","exp.vermap":"⌖ VER NO MAPA","exp.nomatch":"Sem coincidências.",
"exp.reg":"REGISTRO","exp.regs":"REGISTROS","exp.de":"DE",
"exp.statExp":"EXPERIÊNCIAS","exp.statEst":"ESTADOS","exp.statCampo":"DE CAMPO",
...
"cert.ph":"🔍 Buscar por nome, instituição ou ano...","cert.noresults":"Sem resultados para sua busca.","cert.showing":"Mostrando","cert.de":"de","cert.try":"Tente:","cert.badge":"CERTIFICADO","cert.view":"Vista de consulta","cert.imgerr":"Não foi possível carregar a imagen.",
...
"v.ready":"Pronto para verificar","v.official":"Página oficial ↗","v.connecting":"Conectando a titulacion.ucol.mx…","v.validating":"Validando código de verificação…","v.showing":"Mostrando resultado…","v.done":"Verificação oficial · Universidade de Colima",
...
"contact.head":"ESCREVA-ME","contact.headNote":"// ABRE NO SEU CLIENTE DE E-MAIL",
...
"contact.submit":"ABRIR NO SEU E-MAIL ✉","contact.hint":"Sem servidores intermediários: a mensagem é redigida no seu próprio e-mail.",
"contact.mail":"E-MAIL","contact.tel":"TELEFONE","contact.linkedin":"LINKEDIN","contact.copy":"COPIAR","contact.copied":"COPIADO ✓","contact.open":"ABRIR ↗",
